...
%\usepackage{listings}
\usepackage{moreverb}
% Original settings for letter-size paper with thin margins
%\usepackage[letterpaper,bmargin=1.1cm,rmargin=0.95cm,lmargin=0.95cm,tmargin=1cm,headsep=0.2cm,footskip=0.5cm]{geometry}
% Custom settings for small paper while working
\usepackage[papersize={5.5in,8.5in},bmargin=1.5cm,rmargin=1cm,lmargin=1cm,tmargin=1cm,headsep=0.2cm,footskip=0.5cm]{geometry}
...
% customizations for Potuguese version
% via https://www.overleaf.com/learn/latex/Portuguese
\usepackage[T1]{fontenc}
...
\ifthenelse{\boolean{FORLA}}{
	\input{99.LA_sympy_tutorial.tex}
}{}
